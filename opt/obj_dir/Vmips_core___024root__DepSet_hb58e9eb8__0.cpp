...
VL_INLINE_OPT void Vmips_core___024root___sequent__TOP__0(Vmips_core___024root* vlSelf) {
    ...
    if ((1U & (~ (IData)(vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb0_reg)))) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem[vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr0_reg] 
            = vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__din0_reg;
    }
    if ((1U & (~ (IData)(vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb0_reg)))) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem[vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr0_reg] 
    ...
    if ((1U & (~ (IData)(vlSelf->mips_core__DOT__D_CACHE__DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg)))) {
    ...
    if ((1U & (~ (IData)(vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg)))) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__old_data 
            = vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem
            [vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr1_reg];
    }
    if ((1U & (~ (IData)(vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg)))) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__old_data 
            = vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem
