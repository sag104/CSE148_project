...
VL_ATTR_COLD void Vmips_core___024root___ctor_var_reset(Vmips_core___024root* vlSelf) {
    ...
    vlSelf->mips_core__DOT__I_CACHE__DOT__r_index = VL_RAND_RESET_I(5);
    vlSelf->mips_core__DOT__I_CACHE__DOT__r_tag = VL_RAND_RESET_I(17);
    ...
    vlSelf->mips_core__DOT__I_CACHE__DOT__databank_waddr = VL_RAND_RESET_I(6);
    vlSelf->mips_core__DOT__I_CACHE__DOT__databank_raddr = VL_RAND_RESET_I(6);
    for (int __Vi0=0; __Vi0<4; ++__Vi0) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__databank_rdata[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbank_we = VL_RAND_RESET_I(2);
    for (int __Vi0=0; __Vi0<2; ++__Vi0) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbank_rdata[__Vi0] = VL_RAND_RESET_I(17);
    }
    vlSelf->mips_core__DOT__I_CACHE__DOT__valid_bits = VL_RAND_RESET_Q(64);
    vlSelf->mips_core__DOT__I_CACHE__DOT__lru_bits = VL_RAND_RESET_I(32);
    vlSelf->mips_core__DOT__I_CACHE__DOT__hit0 = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__hit1 = VL_RAND_RESET_I(1);
    ...
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__new_data = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__old_data = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__new_data_flag = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb0_reg = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr0_reg = VL_RAND_RESET_I(5);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__din0_reg = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr1_reg = VL_RAND_RESET_I(5);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__0__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem[__Vi0] = VL_RAND_RESET_I(17);
    }
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__new_data = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__old_data = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__new_data_flag = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb0_reg = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr0_reg = VL_RAND_RESET_I(5);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__din0_reg = VL_RAND_RESET_I(17);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg = VL_RAND_RESET_I(1);
    vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__addr1_reg = VL_RAND_RESET_I(5);
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
        vlSelf->mips_core__DOT__I_CACHE__DOT__tagbanks__BRA__1__KET____DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__mem[__Vi0] = VL_RAND_RESET_I(17);
    }
    for (int __Vi0=0; __Vi0<32; ++__Vi0) {
    ...
    vlSelf->mips_core__DOT__D_CACHE__DOT__tagbank__DOT__genblk1__DOT__BANK_CORE__DOT__csb1_reg = VL_RAND_RESET_I(1);
