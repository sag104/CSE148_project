...
VL_ATTR_COLD void Vmips_core_alu_pass_through_ifc___ctor_var_reset(Vmips_core_alu_pass_through_ifc* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vmips_core__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+          Vmips_core_alu_pass_through_ifc___ctor_var_reset\n"); );
    // Body
    vlSelf->is_branch = VL_RAND_RESET_I(1);
    vlSelf->prediction = VL_RAND_RESET_I(1);
    vlSelf->recovery_target = VL_RAND_RESET_I(26);
    vlSelf->is_mem_access = VL_RAND_RESET_I(1);
    vlSelf->mem_action = VL_RAND_RESET_I(1);
    vlSelf->sw_data = VL_RAND_RESET_I(32);
